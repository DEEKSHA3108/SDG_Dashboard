...
#     st.markdown("""
#     Welcome to the SDG Dashboard: Gender Inequality & Economic Growth

#     In today’s data-driven landscape, understanding the **intersection of gender equality and economic performance** is critical for shaping inclusive policies and sustainable development strategies.

#     This dashboard is designed to visually explore key insights from the **Sustainable Development Goals (SDG)**, specifically:
...
#     st.markdown("<h2 id='about'>About This Dashboard</h2>", unsafe_allow_html=True)
#     st.markdown("""
